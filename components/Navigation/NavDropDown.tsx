    ...
    <div className="dropdown dropdown-end pt-1">
      ...
      <ul
        ...
        <button>
            ...
            />
            <p className="inline pl-2 font-Poppins font-[600] text-[16px]">Profile</p>
            </button>
        </li>
        <li>
        <button>
            <img
              ...
              className="inline pl-2"
            />
            <p className="inline pl-2 font-Poppins font-[600] text-[16px]">Favourites</p>
            </button>
        </li>
        <li>
        <button>
            <img
              ...
              className="inline pl-2"
            />
            <p className="inline pl-2 font-Poppins font-[600] text-[16px]">Wallet</p>
            </button>
        </li>
        <li>
          <button onClick={logout}>
            <img
              ...
              className="inline pl-2"
            />
            <p className="inline pl-2 font-Poppins font-[600] text-[16px]">Log Out</p>
          </button>
        </li>
      </ul>
    </div>
